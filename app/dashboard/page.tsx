    ...
    <div className="pt-6 space-y-6">
      ...
      >
        ...
        <div className="flex gap-4 mt-6">
          <div className="flex-1">
            ...
            <p className="text-lg font-extralight text-income">
          ...
          <div className="flex-1">
            ...
            <p className="text-lg font-extralight text-expense">
      ...
      <div className="flex gap-3">
        <motion.button
          ...
          className="flex-1 flex items-center justify-center gap-2 py-4 bg-income/10 border border-income/20 rounded-2xl text-income text-sm font-light tracking-wider transition-smooth"
        >
        ...
        <motion.button
          ...
          className="flex-1 flex items-center justify-center gap-2 py-4 bg-expense/10 border border-expense/20 rounded-2xl text-expense text-sm font-light tracking-wider transition-smooth"
        >
          <Plus className="w-4 h-4" strokeWidth={1.5} />
          Uscita
        </motion.button>
          ...
          <div className="space-y-2">
            {recentTransactions.map((t, i) => (
              <motion.div
                ...
                className="flex items-center justify-between py-3 px-4 bg-foreground/[0.02] rounded-2xl"
              >
                <div>
